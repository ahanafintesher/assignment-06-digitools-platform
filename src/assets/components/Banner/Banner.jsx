      ...
      <div className="flex flex-col-reverse lg:flex-row justify-between items-center gap-8">
        ...
        <div className="text-center lg:text-left">
          <div className="bg-purple-100 border border-purple-300 text-purple-700 rounded-full px-4 py-2 inline-flex gap-2 items-center">
            ...
            <p className="font-semibold text-sm lg:text-lg text-transparent bg-clip-text bg-linear-to-r from-purple-600 to-blue-500">
          ...
          <div className="mt-8 flex gap-2 justify-center lg:justify-start">
            <button className="btn text-white bg-linear-to-r from-indigo-600 to-purple-500 rounded-full font-bold p-4 hover:scale-105 transition-all duration-300">
              Explore Products
            </button>
            <button className="btn btn-outline border-2 border-purple-500 text-purple-500 font-bold rounded-full p-4 hover:bg-linear-to-r hover:from-purple-600 hover:to-blue-500 hover:text-white hover:border-none hover:scale-105 transition-all duration-300">
